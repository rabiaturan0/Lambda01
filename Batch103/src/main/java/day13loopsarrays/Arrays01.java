...
public class Arrays01 {
    ...
    /*
    1)Ayni data tpinde coklu Datayi depolamak icin Java nin olusturdugu yapilar vardir.
      Bu yapilardan biri de "array"dir.
     */
    public static void main(String[] args) {
        ...
        //Example 1: Array'deki en kucuk ve en buyk elemani ekrana yazdiriniz
        Arrays.sort(stdAges);
