...
public class Variables01 {
    ...
    //1)Access Modifier  2)Data Type  3)Varıable ismi  4)=  5)Deger  6);
    ...
    // "Assignment(Atama) opeartor" sagdaki degeri alir soldaki variable'in icine koyar
    ...
    /*
      ...
      1)int: Integer'in kisaltmasi. Integer tam sayi demektir.
       ...
       2)byte: Tamsayilar icin kullanilir.
        ...
        3)short: Tamsailar icin
                 En kucuk short = -32768
                 En buyuk short = 32767

        4)long: Tmsayilar icindir.
        ...
        8)char: Tek karakterler icin kullanilir. 16 bit kullanilir
          ...
          Note: Java buyuk vekucuk harflere duyarlidir.
      ...
      String: Isim, adres, kimlik numarasi gibi bir veya birden fazla karakter iceren degerlerde kullanilir.
              String degerleri mutlaka çift tirnak arasina konulmalidir.
              ...
              1)Non-primitive data type'larinda degerin yaninda method'lar vardır.
    ...
    public long populationOfWord = 7000000000L;
