...
public class StringManipulation01 {
    public static void main(String[] args) {
        ...
        int idxI = s.indexOf('i');//indexOf hem String ile hemde char ile kullanilir.

        System.out.println(idxI);//1

        int idxIss1 = s.indexOf("iss");//Ilk ground "ilk" caharacterinin index ini verir.
        System.out.println(idxIss1);

        int idxIss2 = s.lastIndexOf("iss");//Son gorunumun "ilk" caharacter inin index ini verir.
        ...
        //en bastan bu ixdex e kadar olan karakterleri bir kutu icine aliniz ve lastIndexOf() method unu sadece
        //bu kutu icindeki String icin kullaniniz
