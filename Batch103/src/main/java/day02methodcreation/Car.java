...
public class Car {
    ...
    /*
            Note: Class ==> Variable ==> Object ==> Kullancagiz
     */

    public static void main(String[] args) {

        //Objevt nasil olusturulur?
        //1)Class ismini yaziniz    2)Objeye bie isim veriniz    3) =   4)new keyword'unu kullan     5)Class ismi parantezle beraber(Constructor)
                  Car                        myHonda                =           new                         Car();
