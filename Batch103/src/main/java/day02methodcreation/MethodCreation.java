...
public class MethodCreation {
    ...
    //Example 2: Uc sayiyi birbiri ile carpan bir method olusturun
    public static double ucSayiyiCarp(double a, double b, double c){
        return a*b*c;
    }
    //Example 3: Uc sayidan ilk ikisini toplayip ucuncu ile carpin method olusturup, sonucu ekrana yazdiriniz
